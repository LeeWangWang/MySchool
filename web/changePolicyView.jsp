            ...
            <form action="/changePolicyServlet" method="post">
                <div class="tab-pane fade in active" id="home">
                    <div class="input-group">
                        id:<input type="text" placeholder="<%=id%>" value="<%=id%>" readonly="true"
                        style="" name="id_change">
                        <br>
                        ...
                        <textarea type="text" class="form-control" name="content_change" value="<%=content%>" aria-describedby="basic-addon1"
                                  style="width:900px;resize:none; height: 650px; float: left;"><%=content%></textarea>
                        <br>
                        <div style="margin-left: 820px">
                            <input type="submit" value="修改">
                            <a href="/adminAllFindPolicyServlet"><input type="button" value="关闭"></a>
                        </div>
                    </div>
                </div>
            </form>
