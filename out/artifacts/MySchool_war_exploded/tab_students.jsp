...
<body>
    ...
    <script>
        function deleteStudent(tele, coursesName) {
            $.get("student/deleteStudent", {tele:tele, coursesName:coursesName}, function () {
                alert("删除成功");
                location.href="tab_students.jsp?className="+coursesName;
            });
        }
            ...
            $.get("student/findStudentPage",{className:className, currentPage:currentPage, search:search}, function (pageDate) {
                ...
                for (var i = 0; i < pageDate.list.length; i++) {
                    ...
                    var li ='<tr>' +
                        ...
                        '<td>\n' +
                        '    <a href="student_detail.jsp?tele='+student.tele+'&className='+student.coursesName+'" class="layui-btn layui-btn-mini news_edit"><i class="iconfont icon-edit"></i> 编辑</a>\n' +
                        '<a href="javascript:void(0)" onclick="deleteStudent(\''+student.tele+'\',\''+student.coursesName+'\')" class="layui-btn layui-btn-danger layui-btn-mini news_del" data-id="13"><i class="layui-icon"></i> 删除</a>\n ' +
                        '</td>' +
                        '</tr>';
                    students_list += li;
                }
